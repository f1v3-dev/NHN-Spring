...
public class TagUpdateController {
    ...
    @GetMapping
    public String getTagUpdateForm(@PathVariable("projectId") Long projectId,
                                   @ModelAttribute TagResponseDto tag,
                                   Model model) {
    ...
    @PutMapping
    public String updateTag(@PathVariable("projectId") Long projectId,
